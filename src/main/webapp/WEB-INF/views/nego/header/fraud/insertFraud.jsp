...
<link rel="stylesheet" type="text/css" href="resources/css/header/fraud/fraudInsert.css">
...
<main>
    ...
    <div class="container1">
        ...
        <div class="insertFraud">
            <form>
                <h3>신고 대상</h3>
                <input type="text" name="fraudAccount" placeholder="신고할 휴대전화번호, 계좌번호, 메신저 ID, 이메일 입력"><br>
                <h3>피해 금액</h3>
