...
<div class="container1">
	<div align="center">
	<form name="f" action="edit_Reviews.do" method="post"
		onsubmit="return check()">
		<input type="hidden" name="product_id" value="${findReviews.product_id}"/>
		 <h3 style="color: #007bff;">후기글 수정</h3><br>
		<table>
			<tr>
				<th>작성자</th>
				<td><input type="text" name="sender_id" class="box"
					value="${findReviews.sender_id}" readOnly></td>
			</tr>
			<tr>
				<th>판매자</th>
				<td><input type="text" name="receiver_id" class="box"
					value="${findReviews.receiver_id}" readOnly></td>
			</tr>
			<tr>
				<th>상품 이름</th>
				<td><input type="text" name="product_name" class="box"
					size="50" value="${findReviews.product_name}" readOnly></td>
			</tr>
			<tr>
				<th>내 용</th>
